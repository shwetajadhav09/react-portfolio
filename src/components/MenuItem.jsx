...
const MenuItem = ({menu, index}) => {
  ...
  return (
     <a href={menu.uri} className="w-12 h-12 rounded-full flex items-center justify-center group cursor-pointer hover:bg-gradient-to-br
    ...
    <menu.Icon
     ...
     <AnimatePresence>
      {isHoverred && (
        ...
        after:absolute after:right-0 after:top-3 after:w-3 after:h-3 
